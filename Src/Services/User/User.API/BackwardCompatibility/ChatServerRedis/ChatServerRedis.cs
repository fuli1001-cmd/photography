...
namespace Photography.Services.User.API.BackwardCompatibility.ChatServerRedis
{
    public class ChatServerRedis : IChatServerRedis
    {
        ...
        //public async Task WriteGroupToRedisAsync(Group group)
        //{
        ...
        //public async Task WriteGroupMemberToRedisAsync(Guid userId, int chatServerGroupId)
        //{
        ...
        //public async Task WriteGroupMessageToRedisAsync(Group group, SysMsgType msgType)
        //{
        //    var owner = await _userRepository.GetByIdAsync(group.OwnerId);
        ...
        //    await WriteMessageToRedisAsync(msg);
        //}
