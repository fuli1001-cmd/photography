...
namespace Photography.Services.Post.API.Controllers
{
    ...
    public class StreamingController : ControllerBase
    {
        ...
        public StreamingController(ILogger<StreamingController> logger, IOptions<StreamingSettings> streamingSettings)
        {
            ...
            _logger.LogInformation("*****FileSizeLimit：{FileSizeLimit}", _streamingSettings.Value.FileSizeLimit);
            _logger.LogInformation("*****StoredFilesPath：{FileSizeLimit}", _streamingSettings.Value.StoredFilesPath);
        }
